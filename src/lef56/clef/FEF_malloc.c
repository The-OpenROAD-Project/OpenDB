...
/* ******************************************************************** */
void   *
FEF_calloc(int num_elem, int elem_size, const char *comment)
{
...
/* ******************************************************************** */
void   *
FEF_malloc(int num_bytes, const char *comment)
{
  void   *ptr;
...
/* ******************************************************************** */
void   *
FEF_free_then_malloc(void *ptr, int num_bytes, const char *comment)
{
  if (lefDebug[1])
...
/* ******************************************************************** */
void   *
FEF_realloc(void *ptr, int num_bytes, const char *comment)
{
  if (lefDebug[1])
...
/* ******************************************************************** */
void   *
FEF_relax(void *ptr, int num_bytes, const char *comment)
{
  void   *old_ptr;
...
/* ******************************************************************** */
void 
FEF_free(void *ptr, const char *comment)
{
  if (lefDebug[1])
...
/*
 * Replacement for malloc() that keeps track of what's out, and can free it
 * all
 */
static int nout = 0;
