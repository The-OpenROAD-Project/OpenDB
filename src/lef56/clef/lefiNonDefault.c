			...
			const char *name)
{
  ...
  if (this->numLayers_ == this->layersAllocated_) {
    ...
    newd = (double *) lefMalloc(sizeof(double) * this->layersAllocated_);
    ...
    newhd = (char *) lefMalloc(sizeof(char) * this->layersAllocated_);
...
void 
lefiNonDefault_addDiagWidth(lefiNonDefault * this,
			    double num)
{
...
void 
lefiNonDefault_setHardspacing(lefiNonDefault * this)
{
  this->hardSpacing_ = 1;
}

void 
lefiNonDefault_addUseVia(lefiNonDefault * this,
			 const char *name)
{
...
void 
lefiNonDefault_addUseViaRule(lefiNonDefault * this,
			     const char *name)
{
...
void 
lefiNonDefault_addMinCuts(lefiNonDefault * this,
			  const char *name,
			  int numCuts)
{
...
int 
lefiNonDefault_hasLayerDiagWidth(const lefiNonDefault * this,
				 int index)
{
  if (index < 0 || index >= this->numLayers_) {
    lefiError("Bad index in non default");
...
double 
lefiNonDefault_layerDiagWidth(const lefiNonDefault * this,
			      int index)
{
  if (index < 0 || index >= this->numLayers_) {
    lefiError("Bad index in non default");
...
int 
lefiNonDefault_hasHardspacing(const lefiNonDefault * this)
{
  return this->hardSpacing_;
}

int 
lefiNonDefault_numUseVia(const lefiNonDefault * this)
{
  return this->numUseVias_;
}

const char *
lefiNonDefault_viaName(const lefiNonDefault * this,
		       int index)
{
...
int 
lefiNonDefault_numUseViaRule(const lefiNonDefault * this)
{
  return this->numUseViaRules_;
}

const char *
lefiNonDefault_viaRuleName(const lefiNonDefault * this,
			   int index)
{
...
int 
lefiNonDefault_numMinCuts(const lefiNonDefault * this)
{
  return this->numMinCuts_;
}

const char *
lefiNonDefault_cutLayerName(const lefiNonDefault * this,
			    int index)
{
...
int 
lefiNonDefault_numCuts(const lefiNonDefault * this,
		       int index)
{
  if (index < 0 || index >= this->numMinCuts_) {
    lefiError("Bad index in non default");
  ...
  for (i = 0;
    ...
    if (lefiNonDefault_hasLayerWidth(this,
      ...
      fprintf(f, " WIDTH %g\n", lefiNonDefault_layerWidth(this,
							  i));
    if (lefiNonDefault_hasLayerDiagWidth(this,
					 i))
      fprintf(f, " DIAGWIDTH %g\n", lefiNonDefault_layerDiagWidth(this,
								  i));
