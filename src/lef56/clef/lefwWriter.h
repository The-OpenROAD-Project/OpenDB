...
/*
 * orient 0 = N 1 = W 2 = S 3 = E 4 = FN 5 = FW 6 = FS 7 = FE
 */
 ...
 * once. Returns 0 if successful.
 */
EXTERN int lefwVersion(int vers1, int vers2);

/*
 * This routine is called after lefwInit. This routine can be called only
 * once. Returns 0 if successful. The caseSensitive can be ON or OFF.
 */
EXTERN int lefwCaseSensitive(const char *caseSensitive);

/*
 * This routine is called after lefwInit. This routine can be called only
 * once. Returns 0 if successful. The noWireExtensionAtPin can be ON or OFF.
 */
EXTERN int lefwNoWireExtensionAtPin(const char *noWireExt);

/*
 * This routine is called after lefwInit. This routine can be called only
 * once. Returns 0 if successful. already have one
 */
...
/*
 * This routine is called after lefwInit. This routine can be called only
 * once. This is a 5.4 syntax. Returns 0 if successful.
 */
EXTERN int lefwManufacturingGrid(double grid);

/*
 * This routine is called after lefwInit. This routine can be called multiple
 * times. This is a 5.4 syntax. Returns 0 if successful.
 */
...
/*
 * This routine is called after lefwInit. This routine can be called only
 * once. Returns 0 if successful. This section of routines is optional. The
 ...
 * due to backwards compatible for pre 5.3. Returns 0 if successful.
 */
 ...
 * if successful. The routine starts the layer section. All of the layers
 ...
 * successful. This routine is called if the layer type is CUT when
...
/*
 * This routine must be called after lefwStartLayer. This section of routines
 * is optional. Returns 0 if successful. This is a 5.5 syntax. This routine
 * is called if the layer type is IMPLANT when lefwStartLayer is called.
 */
EXTERN int lefwLayerWidth(double minWidth);

/*
 * This routine must be called after lefwStartLayer. This routine can be
 * called multiple times. This section of routines is optional. This is a 5.5
 * syntax. Returns 0 if successful. This routine is called if the layer type
 * is CUT when lefwStartLayer is called. The spacing is the minSpacing. The
 * distance is optional.
 */
EXTERN int 
lefwLayerSpacingAdjacent(double spacing,  /* minSpacing */
int viaCuts,  /* either 3 or 4 - optional */
double distance);  /* optional (0) */

/*
 * This routine must be called after lefwStartLayer. This routine can be
 * called multiple times. This section of routines is optional. This is a 5.6
 * syntax. Returns 0 if successful. This routine is called if the layer type
 * is CUT when lefwStartLayer is called. The spacing is the minSpacing.
 */
EXTERN int lefwLayerSpacingCenterToCenter(double spacing); /* minSpacing */

/*
 * This routine must be called after lefwStartLayer. This routine can be
 * called multiple times. This section of routines is optional. This is a 5.6
 * syntax. Returns 0 if successful. This routine is called if the layer type
 * is CUT when lefwStartLayer is called.
 */
EXTERN int 
lefwLayerEnclosure(const char *location,  /* ABOVE|BELOW,optional "" */
double overhang1,
double overhang2,
...
/*
 * This routine must be called after lefwStartLayer. This routine can be
 * called only once per Layer. This section of routines is optional. This is
 * a 5.6 syntax. Returns 0 if successful. This routine is called if the layer
 * type is CUT when lefwStartLayer is called.
 */
 ...
 * routine can be called only once per section. Returns 0 if successful.
 */
 ...
 * successful. The routine starts the layer routing section. All of the
 * layers must follow.
 */
 ...
 * routine is required for LayerRouting. Returns 0 if successful.
 */
EXTERN int 
...
/*
 * This routine must be called only once after lefwStartLayerRouting. Either
 * this routine or lefwLayerRoutingPitchXYDistance can be called but not both
 * This is a 5.6 syntax. Returns 0 if successful.
 */
EXTERN int lefwLayerRoutingPitch(double pitch);

/*
 * This routine must be called only once after lefwStartLayerRouting. Either
 * this routine or lefwLayerRoutingPitch can be called but not both This is a
 * 5.6 syntax. Returns 0 if successful.
 */
EXTERN int lefwLayerRoutingPitchXYDistance(double xDistance, double yDistance);

/*
 * This routine must be called only once after lefwStartLayerRouting. Either
 * this routine or lefwLayerRoutingDiagPitchXYDistance can be called but not
 * both This is a 5.6 syntax. Returns 0 if successful.
 */
EXTERN int lefwLayerRoutingDiagPitch(double distance);

/*
 * This routine must be called only once after lefwStartLayerRouting. Either
 * this routine or lefwLayerRoutingDiagPitch can be called but not both This
 * is a 5.6 syntax. Returns 0 if successful.
 */
EXTERN int 
lefwLayerRoutingDiagPitchXYDistance(double diag45Distance,
double diag135Distance);

/*
 * This routine must be called only once after lefwStartLayerRouting. This is
 * a 5.6 syntax. Returns 0 if successful.
 */
...
/*
 * This routine must be called only once after lefwStartLayerRouting. This
 * routine is optional Either this routine or
 * lefwLayerRoutingOffsetXYDistance can be called but not both Returns 0 if
 * successful.
 */
...
/*
 * This routine must be called only once after lefwStartLayerRouting. This
 * routine is optional Either this routine or lefwLayerRoutingOffset can be
 * called but not both This is a 5.6 syntax. Returns 0 if successful.
 */
EXTERN int lefwLayerRoutingOffsetXYDistance(double xDistance, double yDistance);

/*
 * This routine must be called only once after lefwStartLayerRouting. This
 * routine is optional Returns 0 if successful.
 */
 ...
 */
EXTERN int 
lefwLayerRoutingMinsize(int numRect, double *minWidth,
double *minLength);
 ...
 * This routine is optional. Direction can be either FROMABOVE or FROMBELOW
 * This is a 5.5 syntax. Returns 0 if successful.
 */
EXTERN int lefwLayerRoutingMinimumcutConnections(const char *direction);

/*
 * This routine must be called only once after lefwLayerRoutingMinimumcut.
 * This routine is optional. This is a 5.5 syntax. Returns 0 if successful.
 */
EXTERN int 
 ...
 * This routine is optional Returns 0 if successful.
 */
EXTERN int lefwLayerRoutingSpacing(double spacing);

/*
 * Either this routine or lefwLayerRoutingSpacingLengthThreshold can be
 * called only once after lefwLayerRoutingSpacing. This routine is optional.
 * Returns 0 if successful.
 */
 ...
 * llefwLayerRoutingSpacingRange. This routine is valid only if either or
 * both leftRange and rightRange in lefwLayerRoutingSpacing are non zero
 * Returns 0 if successful.
 */
 ...
 * lefwLayerRoutingSpacingRangeRange can be called once after
 * lefwLayerRoutingSpacingRange. subMinWidth & subMaxWidth are optional.
 * Returns 0 if successful.
 */
EXTERN int 
 ...
 * lefwLayerRoutingSpacingRange. Returns 0 if successful.
 */
EXTERN int lefwLayerRoutingSpacingRangeRange(double minWidth, double maxWidth);

/*
 * Either this routine or lefwLayerRoutingSpacingRange can be called once
 * after lefwLayerRoutingSpacing. minWidth & maxWidth are optional. Returns 0
 * if successful.
 */
EXTERN int 
...
/*
 * This routine must be called only once after lefwStartLayerRouting. This
 * routine is optional and can be called once. This is a 5.5 syntax. width is
 * the maximum width. Returns 0 if successful.
 */
...
/*
 * This routine must be called only once after lefwStartLayerRouting. This
 * routine is optional. This is a 5.5 syntax. Area is the minimum area size
 * limit for metal that encloses an empty area. Width is optional, it says
 * the rule only applies when a donut is careted from a wire of width <=
 * width.  The parameter width is required for the routine
 * lefwLayerRoutineMinenclosedarea.  If width is optional, a "0" value is
 * assigned for that index slot of the array. Returns 0 if successful.
 */
EXTERN int 
...
/*
 * This routine must be called only once after lefwStartLayerRouting. This
 * routine is optional and can be called once. This is a 5.5 syntax. Returns
 * 0 if successful.
 */
...
/*
 * This routine must be called only once after lefwStartLayerRouting. This
 * routine is optional and can be called once. This routine is equivalent to
 * lefwLayerRoutingMinstep, except it also takes the options for type &
 * Lengthsum. This is a 5.5 syntax. Returns 0 if successful.
 */
EXTERN int 
lefwLayerRoutingMinstepWithOptions(double distance,
const char *rule,  /* INSIDECORNER|OUTSIDECO
               * RNER|STEP */
double maxLength);
 ...
 */
EXTERN int 
lefwLayerRoutingProtrusion(double width1, double length,
double width2);

/*
 * This routine must be called only after lefwStartLayerRouting. This routine
 * is optional and can be called multiple times. This is a 5.5 syntax.
 * numLength has the size of the array length. length is an array of length
 * values. Returns 0 if successful.
 */
EXTERN int 
 ...
 * lefwLayerRoutingStartSpacingtableParallel. This routine is required after
 * lefwLayerRoutingStartSpacingtableParallel. This routine can be called
 * multiple times. This is a 5.5 syntax. Returns 0 if successful.
 */
EXTERN int 
...
/*
 * This routine must be called only after
 * lefwLayerRoutingStartSpacingtableInfluence. This routine is required after
 * lefwLayerRoutingStartSpacingtableInfluence. This routine can be called
 * multiple times. This is a 5.5 syntax. Returns 0 if successful.
 */
EXTERN int 
 ...
 * lefwLayerACTableEntries Returns 0 if successful.
 */
 ...
 * lefwLayerACCurrentDensity. Returns 0 if successful.
 */
 ...
 * Routing Returns 0 if successful.
 */
 ...
 * This routine must be called after lefwLayerDCCurrentDensity. This routine
 * is required and can be called only once after each
 * lefwLayerDCCurrentDensity. Returns 0 if successful.
 */
 ...
 * OXIDE3, or OXIDE4.  Each can only be called once within a layer. This
 * routine is valid only if the layer type is either ROUTING or CUT. This is
 * a 5.5 syntax. Returns 0 if successful.
 */
EXTERN int lefwLayerAntennaModel(const char *oxide);

/*
 * This routine must be called after lefwStartLayerRouting or lefwStartLayer.
 * This routine is optional and can be called only once within a layer after
 * each lefwLayerAntennaModel function. This routine is valid only if the
 * layer type is either ROUTING or CUT. This is a 5.4 syntax. Either this
 * routine or lefwLayerRoutingAntennaLength is allowed, not both. Returns 0
 * if successful.
 */
 ...
 * This routine is optional and can be called only once within a layer after
 * each lefwLayerAntennaModel function. This routine is valid only if the
 * layer type is either ROUTING or CUT. Either this routine or
 * lefwLayerAntennaDiffAreaRatioPwl can be called, but not both This is a 5.4
 * syntax. Either this routine or lefwLayerRoutingAntennaLength is allowed,
 * not both. Returns 0 if successful.
 */
 ...
 * each lefwLayerAntennaModel function. This routine is valid only if the
 * layer type is either ROUTING or CUT. Either this routine or
 * lefwLayerAntennaDiffAreaRatio can be called, but not both This is a 5.4
 * syntax. Either this routine or lefwLayerRoutingAntennaLength is allowed,
 * not both. Returns 0 if successful.
 */
EXTERN int 
 ...
 * each lefwLayerAntennaModel function. This routine is valid only if the
 * layer type is either ROUTING or CUT. Either this routine or
 * lefwLayerAntennaCumDiffAreaRatioPwl can be called, but not both This is a
 * 5.4 syntax. Either this routine or lefwLayerRoutingAntennaLength is
 * allowed, not both. Returns 0 if successful.
 */
 ...
 * each lefwLayerAntennaModel function. This routine is valid only if the
 * layer type is either ROUTING or CUT. Either this routine or
 * lefwLayerAntennaCumDiffAreaRatio can be called, but not both This is a 5.4
 * syntax. Either this routine or lefwLayerRoutingAntennaLength is allowed,
 * not both. Returns 0 if successful.
 */
EXTERN int 
 ...
 * This routine is optional and can be called only once within a layer after
 * each lefwLayerAntennaModel function. This routine is valid only if the
 * layer type is either ROUTING or CUT. The option DIFFUSEONLY is a 5.4
 * syntax. If DIFFUSEONLY, lefwLayerRoutingAntennaLength is not allowed. This
 * function is similar to lefwLayerRoutingAntennaArea diffUseOnly has to be
 * DIFFUSEONLY. Returns 0 if successful.
 */
EXTERN int 
 ...
 * This routine is optional and can be called only once within a layer after
 * each lefwLayerAntennaModel function. This routine is valid only if the
 * layer type is either ROUTING. This is a 5.4 syntax. Either this routine or
 * lefwLayerRoutingAntennaLength is allowed, not both. Returns 0 if
 * successful.
 */
 ...
 * This routine is optional and can be called only once within a layer after
 * each lefwLayerAntennaModel function. This routine is valid only if the
 * layer type is either ROUTING. Either this routine or
 * lefwLayerAntennaDiffSideAreaRatioPwl can be called, but not both This is a
 * 5.4 syntax. Either this routine or lefwLayerRoutingAntennaLength is
 * allowed, not both. Returns 0 if successful.
 */
 ...
 * each lefwLayerAntennaModel function. This routine is valid only if the
 * layer type is either ROUTING or CUT. Either this routine or
 * lefwLayerAntennaDiffSideAreaRatio can be called, but not both This is a
 * 5.4 syntax. Either this routine or lefwLayerRoutingAntennaLength is
 * allowed, not both. Returns 0 if successful.
 */
EXTERN int 
 ...
 * each lefwLayerAntennaModel function. This routine is valid only if the
 * layer type is either ROUTING. Either this routine or
 * lefwLayerAntennaCumDiffSideAreaRatioPwl can be called, but not both This
 * is a 5.4 syntax. Either this routine or lefwLayerRoutingAntennaLength is
 * allowed, not both. Returns 0 if successful.
 */
 ...
 * each lefwLayerAntennaModel function. This routine is valid only if the
 * layer type is either ROUTING or CUT. Either this routine or
 * lefwLayerAntennaCumDiffSideAreaRatio can be called, but not both This is a
 * 5.4 syntax. Either this routine or lefwLayerRoutingAntennaLength is
 * allowed, not both. Returns 0 if successful.
 */
EXTERN int 
 ...
 * This routine is optional and can be called only once within a layer after
 * each lefwLayerAntennaModel function. This routine is valid only if the
 * layer type is either ROUTING. The option DIFFUSEONLY is a 5.4 syntax.
 * diffUseOnly has to be DIFFUSEONLY. Returns 0 if successful.
 */
EXTERN int 
...
/*
 * This routine must be called only once after lefwStartLayer. The option
 * SLOTWIREWIDTH is a 5.4 syntax. Returns 0 if successful.
 */
EXTERN int lefwSlotWireWidth(double minWireWidthForSlotting);

/*
 * This routine must be called only once after lefwStartLayer. The option
 * SLOTWIRELENGTH is a 5.4 syntax. Returns 0 if successful.
 */
EXTERN int lefwSlotWireLength(double minWireLengthForSlotting);

/*
 * This routine must be called only once after lefwStartLayer. The option
 * SLOTWIDTH is a 5.4 syntax. Returns 0 if successful.
 */
EXTERN int lefwSlotWidth(double minSlotWidth);

/*
 * This routine must be called only once after lefwStartLayer. The option
 * SLOTLENGTH is a 5.4 syntax. Returns 0 if successful.
 */
EXTERN int lefwSlotLength(double minSlotLength);

/*
 * This routine must be called only once after lefwStartLayer. The option
 * MAXADJACENTSLOTSPACING is a 5.4 syntax. Returns 0 if successful.
 */
EXTERN int lefwMaxAdjacentSlotSpacing(double maxAdjSlotSpacing);

/*
 * This routine must be called only once after lefwStartLayer. The option
 * MAXCOAXIALSLOTSPACING is a 5.4 syntax. Returns 0 if successful.
 */
EXTERN int lefwMaxCoaxialSlotSpacing(double maxCoaxSlotSpacing);

/*
 * This routine must be called only once after lefwStartLayer. The option
 * MAXEDGESLOTSPACING is a 5.4 syntax. Returns 0 if successful.
 */
EXTERN int lefwMaxEdgeSlotSpacing(double maxEdgeSlotSpacing);

/*
 * This routine must be called only once after lefwStartLayer. The option
 * SPLITWIREWIDTH is a 5.4 syntax. Returns 0 if successful.
 */
EXTERN int lefwSplitWireWidth(double minWireWidthForSplitting);

/*
 * This routine must be called only once after lefwStartLayer. The option
 * MINIMUMDENSITY is a 5.4 syntax. Returns 0 if successful.
 */
EXTERN int lefwMinimumDensity(double minDensity);

/*
 * This routine must be called only once after lefwStartLayer. The option
 * MAXIMUMDENSITY is a 5.4 syntax. Returns 0 if successful.
 */
EXTERN int lefwMaximumDensity(double maxDensity);

/*
 * This routine must be called only once after lefwStartLayer. The option
 * DENSITYCHECKWINDOW is a 5.4 syntax. Returns 0 if successful.
 */
EXTERN int 
...
/*
 * This routine must be called only once after lefwStartLayer. The option
 * DENSITYCHECKSTEP is a 5.4 syntax. Returns 0 if successful.
 */
EXTERN int lefwDensityCheckStep(double checkStepValue);

/*
 * This routine must be called only once after lefwStartLayer. The option
 * FILLACTIVESPACING is a 5.4 syntax. Returns 0 if successful.
 */
EXTERN int lefwFillActiveSpacing(double fillToActiveSpacing);

/*
 * This routine must be called only once after all the layers. This routine
 * is optional. This is a 5.5 syntax. Returns 0 if succesful.
 */
EXTERN int 
 ...
 * optional. The routine can be called only once. Returns 0 if successful.
 ...
 * statement. Returns 0 if successful. The objType can be LIBRARY or VIA or
 * MACRO or PIN.
 */
EXTERN int 
lefwIntPropDef(
 ...
 * Returns 0 if successful. The objType can be LIBRARY or VIA or MACRO or
 * PIN.
 */
EXTERN int 
lefwRealPropDef(
 ...
 * routine can be called only once. Returns 0 if successful.
 */
EXTERN int lefwEndPropDef();

/*
 * This routine is called after lefwInit. This routine must be called only
 * once. Returns 0 if successful. The routine starts the via section. All of
 ...
 * can only be called once. Returns 0 if successful.
 */
...
/*
 * This routine is optional, it call only be called after lefwStartVia. It
 * can only be called once. Returns 0 if successful. This routine is the same
 * as lefwViaForeign, except orient is a char*
 */
EXTERN int 
 ...
 * Either this routine or lefwViaViarule can be called within a via. It can
 * only be called once in a via. Returns 0 if successful.
 */
 ...
 * times. Returns 0 if successful.
 */
EXTERN int lefwViaLayer(const char *layerName); /* LAYER */

/*
 * This routine can call only after lefwViaLayer. Either this routine or
 * lefwViaLayerPolygon can be called within a layer It can be called multiple
 * times. Returns 0 if successful.
 */
EXTERN int 
...
/*
 * This routine can call only after lefwViaLayer. Either this routine or
 * lefwViaLayerRect can be called within a layer It can be called multiple
 * times. This is a 5.6 syntax. Returns 0 if successful.
 */
EXTERN int lefwViaLayerPolygon(int num_polys, double *xl, double *yl);

/*
 * This routine can call only after lefwStartVia. Either this routine or
 * lefwViaResistance can be called within a via. It can only be called once
 * in a via. This is a 5.6 syntax. Returns 0 if successful.
 */
EXTERN int 
...
/*
 * This routine can call only after lefwViaViarule. It can only be called
 * once. This is a 5.6 syntax. Returns 0 if successful.
 */
 ...
 * times. Returns 0 if successful. The routine starts the via rule section.
 ...
 * called 2 times exact. Returns 0 if successful. The direction1 or
 ...
 * 0 if successful. The direction1 or direction2 can be HORIZONTAL or
 * VERTICAL.
 */
EXTERN int 
lefwViaRuleVia(
 ...
 * multiple times. Returns 0 if successful. The routine starts the via rule
 * section. The via rule data and its property must follow
 */
EXTERN int lefwStartViaRuleGen(const char *viaRuleName);

/*
 * This routine is called after lefwSartViaRuleGen. This routine is optional
 * Returns 0 if successful
 */
 ...
 * called 2 times exact. Returns 0 if successful. Either this routine or
 * lefwViaRuleGenLayerEnclosure, not both. The direction1 or direction2 can
...
/*
 * This routine is called after lefwStartViaRuleGen. This routine has to be
 * called 2 times exact. This is 5.5 syntax Returns 0 if successful. Either
 * this routine or lefwViaRuleGenLayer, not both.
 */
EXTERN int 
...
/*
 * This routine is called after lefwInit. This routine must be called only
 * once. Returns 0 if successful. The routine starts the nonDefaultRule
...
double resistance,  /* optinal(0) - RESISTANCE
             * RPERQ */
double capacitance,  /* optinal(0) - CAPACITANCE
             * CPERSQDIST */
double edgeCap);  /* optinal(0) -
             * EDGECAPACITANCE */

/*
 * This routine is called after lefwInit. This routine must be called after
 * lefwStartNonDefaultRule This routine is optional and it can be called only
 * once. Returns 0 if successful.
 */
EXTERN int lefwNonDefaultRuleHardspacing();

/*
 * This routine is called after lefwStartNonDefaultRule. This routine must be
 * called only once for each via section. Returns 0 if successful. The
 * routine starts the nondefaultrule via section. Call the following via
 * functions for the rest of NONDEFAULTRULE VIA: lefwViaTopofstackonly
 * lefwViaForeign lefwViaForeignStr lefwViaResistance lefwViaLayer
 * lefwViaLayerRect lefwNonDefaultRuleEndVia
 */
EXTERN int 
lefwNonDefaultRuleStartVia(const char *viaName,
const char *isDefault);  /* optional(NULL) -
               * DEFAULT */

/*
 * This routine must be called after the lefwNonDefaultRuleStartVia call. The
 * routine can be called only once per via section. Returns 0 if successful.
 */
EXTERN int lefwNonDefaultRuleEndVia(const char *viaName);

/*
 * This routine is called after lefwStartNonDefaultRule. This routine can be
 ...
 * any). The routine can be called only once. Returns 0 if successful.
 */
EXTERN int lefwEndNonDefaultRule(const char *ruleName);

/*
 * This routine is called after lefwInit. This section of routines is
 * optional. This routine can be called only once. Returns 0 if successful.
 ...
 * multiple times. Returns 0 if successful. The stack has to be STACK.
 */
EXTERN int 
 ...
 * be called only once. Returns 0 if successful. This api is obsolete in 5.4.
 */
...
/*
 * This routine is called after lefwInit. This routine is optional and it can
 * be called only once. Returns 0 if successful. This routine starts the
 * noisetable section. This api is obsolete in 5.4.
 */
 ...
 * successful. This api is obsolete in 5.4.
 */
EXTERN int 
 ...
 * can be called only once inside lefwEdgeRate. Returns 0 if successful. This
 * api is obsolete in 5.4.
 */
 ...
 * Returns 0 if successful. This api is obsolete in 5.4.
 */
 ...
 * The routine can be called only once per section. Returns 0 if successful.
 ...
 * This routine is called after lefwInit. This routine is optional and it can
 * be called only once. Returns 0 if successful. This routine starts the
 * correctTable section. This api is obsolete in 5.4.
 */
 ...
 * This routine is called after lefwInit. This routine is optional and it can
 * be called only once. Returns 0 if successful. This routine starts the
 * irdrop section. This api is obsolete in 5.4.
 */
EXTERN int lefwStartIrdrop();

/*
 * This routine is must be called after lefwStartIrdrop. It can be called
 * multiple times. Returns 0 if successful. The currentsNvolts is a list of
 * current and volts. This api is obsolete in 5.4.
 */
 ...
 * routine can be called only once. Returns 0 if successful. This api is
 * obsolete in 5.4.
 */
 ...
 * times. Returns 0 if successful. The classType can be PAD or CORE. The
...
/*
 * This routine is must be called after lefwSite. It can be called multiple
 * times. This is a 5.6 syntax. Returns 0 if successful.
 */
...
/*
 * This routine is must be called after lefwSite. It can be called multiple
 * times. This is a 5.6 syntax. Returns 0 if successful. This routine is the
 * same as lefwSiteRowPattern, except orient is a char*
 */
EXTERN int lefwSiteRowPatternStr(const char *siteName, const char *orient);

/*
 * This routine must be called after the lefwSite call (if any). The routine
 * can be called only once after lefwSite. This is a 5.4 syntax. Returns 0 if
 * successful.
 */
...
/*
 * This routine is called after lefwInit. This routine is optional and it can
 * be called multiple times. Returns 0 if successful. This routine starts the
 * array section.
 */
 ...
 * multiple times. Returns 0 if successful.
 */
EXTERN int 
 ...
 * lefwArrayCanplace, lefwArrayCannotoccupy, lefwArrayTracks, or
 * lefwStartArrayFloorplan must be called at least once. It can be call
 * multiple times. Returns 0 if successful. This routine is the same as
 * lefwArraySite, except orient is a char*
 */
EXTERN int 
 ...
 * lefwStartArrayFloorplan must be called at least once. It can be call
 * multiple times. Returns 0 if successful. This routine is the same as
 * lefwArrayCanplace, except orient is a char*
 */
EXTERN int 
 ...
 * lefwStartArrayFloorplan must be called at least once. It can be call
 * multiple times. Returns 0 if successful. This routine is the same as
 * lefwArrayTracks, except orient is a char*
 */
EXTERN int 
lefwArrayCannotoccupyStr(const char *name, double origX,
 ...
 * times. Returns 0 if successful. The routine starts the array floorplan
 * section
 */
 ...
 * This routine must be called after lefwStartArrayFloorplan. It can be
 * called multiple times. Returns 0 if successful. The site can be CANPLACE
 * or CANNOTOCCUPY This routine is the same as lefwArrayFloorplan, except
 * orient is a char*
 */
EXTERN int 
lefwArrayFloorplanStr(const char *site, const char *name,
 ...
 * can be called multiple times. Returns 0 if successful. The xy can be X or
 * Y.
 */
EXTERN int 
 ...
 * optional and can be call only once. Returns 0 if successful. The routine
 ...
 * multiple times. Returns 0 if successful. This routine starts the macro
 * section.
 */
 ...
 * can be called only once per macro section. Returns 0 if successful. The
 * value1 can be COVER, RING, BLOCK, PAD, CORE, or ENCAP. The value2 can be
 * BUMP if value1 is COVER, or BLACKBOX, or SOFT if value1 is BLOCK, or
 * INPUT, OUTPUT, INOUT, POWER, or SPACER if value1 is PAD, or FEEDTHRU,
 * TIEHIGH, TIELOW, SPACER, ANTENNACELL, or WELLTAP if value1 is CORE, or
 * PRE, POST, TOPLEFT, TOPRIGHT, BOOTOMLEFT, or BOTTOMRIGHT if value1 is
 * ENCAP.
 */
EXTERN int 
...
/*
 * This routine is called after lefwStartMacro. This routine is optional and
 * can be called multiple times per macro section. Returns 0 if successful.
 */
EXTERN int 
...
/*
 * This routine is called after lefwStartMacro. This routine is optional and
 * can be called only once per macro section. Returns 0 if successful.
 */
EXTERN int 
 ...
 * only once per macro section. Returns 0 if successful.
 */
...
/*
 * This routine is called after lefwStartMacro. This routine must be called
 * at least once per macro section. Returns 0 if successful.
 */
EXTERN int 
...
/*
 * This routine is called after lefwStartMacro. This routine must be called
 * at least once per macro section. Returns 0 if successful. This routine is
 * the same as lefwMacroSitePattern, except orient is a char*
 */
EXTERN int 
...
/*
 * This routine is called after lefwStartMacro. This routine is optional and
 * can be called only once per macro section. Returns 0 if successful. This
 * api is obsolete in 5.4.
 */
...
/*
 * This routine is called after lefwStartMacro. This routine is optional and
 * can be called only once per macro section. This is a 5.6 syntax. Returns 0
 * if successful.
 */
EXTERN int lefwStartMacroDensity(const char *layerName);

/*
 * This routine is called after lefwStartMacroDensity. This routine can be
 * called multiple times. This is a 5.6 syntax. Returns 0 if successful.
 */
EXTERN int 
lefwMacroDensityLayerRect(double x1, double y1,
double x2, double y2,
double densityValue);

/*
 * This routine must be called after the lefwStartMacroPin call (if any). The
 * routine can be called only once per macro section. This is a 5.6 syntax.
 * Returns 0 if successful.
 */
...
/*
 * This routine must be called after the lefwStartMacro call (if any). The
 * routine can be called multiple time. Returns 0 if successful. It starts
 ...
 * and can be called only once. Returns 0 if successful.
 */
...
/*
 * This routine is called after lefwStartMacroPin. This routine is optional
 * and can be called only once. Returns 0 if successful. Ths routine is the
 * same as lefwMacroPinForeign, except orient is a char*
 */
EXTERN int 
...
/*
 * This routine is called after lefwStartMacroPin. This routine is optional
 * and can be called only once. Returns 0 if successful. The direction can be
 * INPUT, OUTPUT, OUTPUT TRISTATE, INOUT, or FEEDTHRU.
 */
EXTERN int lefwMacroPinDirection(const char *direction);

/*
 * This routine is called after lefwStartMacroPin. This routine is optional
 * and can be called only once. Returns 0 if successful. The use can be
...
/*
 * This routine is called after lefwStartMacroPin. This routine is optional
 * and can be called only once. Returns 0 if successful. The namce can be
...
/*
 * This routine is called after lefwStartMacroPin. This routine is optional
 * and can be called only once. This is a 5.6 syntax. Returns 0 if
 * successful.
 */
...
/*
 * This routine is called after lefwStartMacroPin. This routine is optional
 * and can be called only once. Returns 0 if successful. This api is obsolete
 * in 5.4.
 */
...
/*
 * This routine is called after lefwStartMacroPin. This routine is optional
 * and can be called only once. Returns 0 if successful. The name can be
 * ACTIVE or RESISTIVE. This api is obsolete in 5.4.
 */
...
/*
 * This routine is called after lefwStartMacroPin. This routine is optional
 * and can be called multiple times. Either this routine or 5.4 Antenna
 * syntax, cannot be both Returns 0 if successful.
 */
EXTERN int 
...
/*
 * This routine is called after lefwStartMacroPin. This routine is optional
 * and can be called multiple times. This is a 5.4 syntax. Either this
 * routine or 5.3 Antenna syntax, cannot be both Returns 0 if successful.
 */
EXTERN int 
...
/*
 * This routine is called after lefwStartMacroPin. The oxide value, can be
 * either OXIDE1, OXIDE2, OXIDE3, or OXIDE4. This routine is optional. Each
 * oxide value can be called only once after the lefwStartMacroPin. This is a
 * 5.5 syntax. Returns 0 if successful.
 */
...
/*
 * This routine is called after lefwStartMacroPin. This routine is optional
 * and can be called only once. This is a 5.4 syntax. Either this routine or
 * 5.3 Antenna syntax, cannot be both Returns 0 if successful.
 */
EXTERN int 
 ...
 * lefwMacroPinPortDesignRuleWidth must be called, but can't be both. Spacing
 * is optional for minimum spacing. Returns 0 if successful.
 */
EXTERN int 
...
/*
 * This routine is called after lefwStartMacroPinPort. Either this routine or
 * lefwMacroPinPortLayer must be called, but can't be both. width is optional
 * for DesignRuleWidth This is a 5.4 syntax. Returns 0 if successful.
 */
EXTERN int 
 ...
 * lefwStartMacroPinPortLayerPolygon must be called. Returns 0 if successful.
 */
EXTERN int 
 ...
 * must be called. Returns 0 if successful.
 */
EXTERN int 
...
/*
 * This routine is called after lefwStartMacroPinPort. Either this routine or
 * lefwStartMacroPinPortLayer must be called. Returns 0 if successful.
 */
EXTERN int 
 ...
 * is optional and can be called multiple times. Returns 0 if successful. It
 * starts the macro obs section within macro.
 */
EXTERN int lefwStartMacroObs();

/*
 * This routine is called after lefwStartMacroObs. Either this routine,
 * lefwMacroObsDesignRuleWidth or lefwMacroObsVia must be called. Spacing is
 * optional for minimum spacing. Returns 0 if successful.
 */
EXTERN int 
...
/*
 * This routine is called after lefwStartMacroObs. Either this routine,
 * lefwMacroObsLayer or lefwMacroObsVia must be called. Spacing is optional
 * for minimum spacing. This is a 5.4 syntax. Returns 0 if successful.
 */
EXTERN int 
...
/*
 * This routine is called after lefwStartMacroObs. Returns 0 if successful.
 */
 ...
 * lefwMacroObsLayer|lefwMacroObsDesignRuleWidth must be called. Returns 0 if
 * successful.
 */
EXTERN int 
...
/*
 * This routine is called after the lefwStartMacro call (if any). The routine
 * is optional and can be called only once. Returns 0 if successful. It
 * starts the macro timing section within macro. This api is obsolete in 5.4.
 */
EXTERN int lefwStartMacroTiming();

/*
 * This routine must be called after the lefwStartMacroTiming. It can be
 * called multiple times. Returns 0 if successful. This routine is for
 * {FROMPIN pinName...; [TOPIN pinName...;] | FROMPIN pinName...;} This
 * routince can be called multiple times. The num_frPinNames contains the
 * number of object in the array fromPins. This api is obsolete in 5.4.
 */
EXTERN int lefwMacroTimingPin(const char *fromPin, const char *toPin);

/*
 * This routine must be called after the lefwStartMacroTiming. It can be
 * called multiple times. Returns 0 if successful. The riseFall can be RISE
 * or FALL. This api is obsolete in 5.4.
 */
EXTERN int 
...
/*
 * This routine must be called after the lefwStartMacroTiming. It can be
 * called multiple times. Returns 0 if successful. This api is obsolete in
 * 5.4.
 */
...
/*
 * This routine must be called after the lefwStartMacroTiming. It can be
 * called multiple times. Returns 0 if successful. The unateness can be
 * INVERT, NONINVERT or NONUNATE. This api is obsolete in 5.4.
 */
 ...
 * The routine can be called only once. Returns 0 if successful. This api is
 * obsolete in 5.4.
 */
 ...
 * only once. Returns 0 if successful.
 */
EXTERN int lefwEnd();
