...
python3 ./OpenDB/tests/python/03-dump_via_rules_test.py
echo "SUCCESS!"
echo ""

echo "[4] Dump vias"
python3 ./OpenDB/tests/python/04-dump_vias_test.py
echo "SUCCESS!"
echo ""

echo "[5] Read DEF"
python3 ./OpenDB/tests/python/05-read_def_test.py
echo "SUCCESS!"
echo ""

echo "[6] Read design"
python3 ./OpenDB/tests/python/06-read_design_test.py
echo "SUCCESS!"
echo ""

echo "[7] Dump nets"
python3 ./OpenDB/tests/python/07-dump_nets_test.py
echo "SUCCESS!"
echo ""

echo "[8] Write LEF/DEF file"
python3 ./OpenDB/tests/python/08-write_lef_and_def_test.py
echo "SUCCESS!"
echo ""

echo "[9] Database LEF access tests"
python3 ./OpenDB/tests/python/09-lef_data_access_test.py
echo "SUCCESS!"
echo ""
