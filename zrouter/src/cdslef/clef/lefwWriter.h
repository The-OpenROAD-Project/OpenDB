 ...
 * distance is optional, it is for ADJACENTWITHIN.
 */
EXTERN int 
...
/*
 * This routine must be called only once after lefwStartLayerRouting. This
 * routine is required for SE only Returns 0 if successful.
 */
 ...
 * can be called multiple times. Returns 0 if successful.
 */
EXTERN int 
 ...
 */
EXTERN int 
lefwMacroSitePatternStr(const char *name, double origX,
