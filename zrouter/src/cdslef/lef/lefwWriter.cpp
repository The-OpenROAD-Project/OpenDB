...
char lefwStateStr[MAXSYN] [80] = {"UNITS",                 //  0
                                  ...
                                  "MACRO_IV_TABLES",       // 40
                                  "MACRO_LEAKAGE",         // 41
                                  "MACRO_OUTPUTNOISEMARGIN",   // 42
                                  "MACRO_OUTPUTRESISTANCE",    // 43
                                  "MACRO_POWER",           // 44
                                  "MACRO_PULLDOWNRES",     // 45
                                  "MACRO_RESISTANCE",      // 46
                                  "MACRO_RISESATCUR",      // 47
                                  "MACRO_RISETHRESH",      // 48
                                  "MACRO_RISEVOLTAGETHRESHOLD",// 49
                                  "MACRO_TIEOFFR",         // 50
                                  "MACRO_TIMING",          // 51
                                  "MACRO_VHI",             // 52
                                  "MACRO_VLO",             // 53
                                  ...
                                  "NOISEMARGIN",           // 56
                                  "NOISETABLE",            // 57
                                  "NOWIREEXTSIONATPIN",    // 58
                                  "PROPERTYDEFINITION",    // 59
                                  "EDGERATESCALEFACTOR",   // 60
                                  "SITE",                  // 61
                                  "SPACING",               // 62
                                  "EDGERATETHRESHOLD1",    // 63
                                  "EDGERATETHRESHOLD2",    // 64
                                  "UNTIS",                 // 65
                                  "VERSION",               // 66
                                  "VIA",                   // 67
                                  "VIARULE",               // 68
                                  ...
                                  "LAYER",                 // 75
                                  "LAYERROUTING",          // 76
                                  "LAYERROUTINGSPACINGTABLE",        // 77
                                  "MACRO",                 // 78
                                  "NOISETABLE",            // 79
                                  "NONDEFAULTRULE",        // 80
                                  "PROERTYDEFINITION",     // 81
                                  "SITE",                  // 82
                                  "SPACING",               // 83
                                  "VIA",                   // 84
                                  "VIARULE",               // 85
                                  "VIARULEGEN",            // 86
                                  "UNITS",                 // 87
                                  "ANTENNAINPUTGATEAREA",  // 88
                                  "ANTENNAINOUTDIFFAREA",  // 89
                                  "ANTENNAOUTPUTDIFFAREA", // 90
                                  "ANTENNAMODEL",          // 91
                                  "ANTENNAAREARATIO",      // 92
                                  "ANTENNADIFFAREARATIO",  // 93
                                  "ANTENNADIFFAREARATIO PWL",        // 94
                                  "ANTENNACUMAREARATIO",   // 95
                                  "ANTENNACUMDIFFAREARATIO",         // 96
                                  "ANTENNACUMDIFFAREARATIO PWL",     // 97
                                  "ANTENNAAREAFACTOR",     // 98
                                  "ANTENNASIDEAREARATIO",  // 99
                                  "ANTENNADIFFSIDEAREARATIO",        // 100
                                  "ANTENNADIFFSIDEAREARATIO PWL",    // 101
                                  "ANTENNACUMSIDEAREARATIO",         // 102
                                  "ANTENNACUMDIFFSIDEAREARATIO", // 103
                                  "ANTENNACUMDIFFSIDEAREARATIO PWL", // 104
                                  "ANTENNASIDEAREAFACTOR", // 105
                                  "ANTENNAPARTIALMETALAREA",         // 106
                                  "ANTENNAPARTIALMETALSIDEAREA",     // 107
                                  "ANTENNAGATEAREA",       // 108
                                  "ANTENNADIFFAREA",       // 109
                                  "ANTENNAMAXAREACAR",     // 110
                                  "ANTENNAMAXSIDEAREACAR", // 111
                                  "ANTENNAPARTIALCUTAREA", // 112
                                  "ANTENNAMAXCUTCAR",      // 113
                                  "CLEARANCEMEASURE",      // 114
                                  "DENSITYCHECKWINDOW",    // 115
                                  "DENSITYCHECKSTEP",      // 116
                                  "DESIGNRULEWIDTH",       // 117
                                  "FILLACTIVESPACING",     // 118
                                  "MANUFACTURINGGRID",     // 119
                                  "MAXADJACENTSLOTSPACING",          // 120
                                  "MAXCOAXIALSLOTSPACING",           // 121
                                  "MAXEDGESLOTSPACING",    // 122
                                  "MAXIMUMDENSITY",        // 123
                                  "MINIMUMDENSITY",        // 124
                                  "ROWABUTSPACING",        // 125
                                  "ROWMINSPACING",         // 126
...
char* lefwOrient(int num) {
  ...
  case 5: return lefwAddr("FW");
  case 6: return lefwAddr("FS");
  case 7: return lefwAddr("FE");
  };
...
int lefwManufacturingGrid (double grid) {
  ...
  if (lefwState != LEFW_INIT && lefwState < LEFW_END)
     return LEFW_BAD_ORDER;  // not of the ENDs
  if (lefwSynArray[LEFW_MANUFACTURINGGRID]) return LEFW_ALREADY_DEFINED;
  if (versionNum < 5.4)
...
int lefwClearanceMeasure (const char* type ) {
  ...
  if (lefwState != LEFW_INIT && lefwState < LEFW_END)
     return LEFW_BAD_ORDER;  // not of the ENDs
  if (lefwSynArray[LEFW_CLEARANCEMEASURE]) return LEFW_ALREADY_DEFINED;
...
int lefwLayer(double spacing,          /* optional */
  ...
  if (lefwState != LEFW_LAYER_START &&
     lefwState != LEFW_LAYER) return LEFW_BAD_ORDER;
  if ((!lefwIsCut) && (!lefwIsImplant)) return LEFW_BAD_DATA;
...
int lefwLayerWidth(double minWidth) {
  ...
  if (lefwState != LEFW_LAYER_START &&
     lefwState != LEFW_LAYER) return LEFW_BAD_ORDER;
  if (!lefwIsImplant) return LEFW_BAD_DATA;  // use cut for implant for now
  if (lefwWriteEncrypt)
...
int lefwLayerSpacingAdjacent(double spacing,      /* optional */
...
int lefwLayerRoutingMinimumcutConnections(const char* direction) {
  if (! lefwFile) return LEFW_UNINITIALIZED;
  if (!lefwIsRoutingMinCut || lefwIsRoutingMinCutDist) return LEFW_BAD_ORDER;
...
int lefwLayerRoutingMinimumcutLengthWithin(double length, double distance) {
  if (! lefwFile) return LEFW_UNINITIALIZED;
  if (!lefwIsRoutingMinCut || lefwIsRoutingMinCutLen) return LEFW_BAD_ORDER;
     // lefwLayerRoutingMinimumcut has not being called or
...
int lefwLayerRoutingSpacingRange(double leftRange, double rightRange) {
  if (! lefwFile) return LEFW_UNINITIALIZED;
  if (lefwState != LEFW_LAYERROUTING_START &&
      lefwState != LEFW_LAYERROUTING) return LEFW_BAD_ORDER;
  if (!lefwIsRouting) return LEFW_BAD_DATA;  // only routing calls this func
  if (!lefwHasLayerRoutingSpacing) return LEFW_BAD_DATA;
  if (lefwWriteEncrypt)
...
int lefwLayerRoutingSpacingRangeInfluence(double infValue, double subMinWidth,
                                          double subMaxWidth) {
  if (! lefwFile) return LEFW_UNINITIALIZED;
  if (lefwState != LEFW_LAYERROUTING_START &&
      lefwState != LEFW_LAYERROUTING) return LEFW_BAD_ORDER;
...
int lefwLayerRoutingMinenclosedarea(int numMinenclosed, double *area, 
                                    double *width) {
  int i;
...
int lefwLayerRoutingSpacingtableParallelWidth(double width,
  ...
  if (lefwState != LEFW_LAYERROUTING_SP_START &&
      lefwState != LEFW_LAYERROUTINGWIDTH) return LEFW_BAD_ORDER;
  if (lefwWriteEncrypt) {
     encPrint(lefwFile, (char*)"\n       WIDTH %g", width);
...
int lefwLayerRoutingSpacingInfluenceWidth(double width, double distance,
                                          double spacing) {
  if (! lefwFile) return LEFW_UNINITIALIZED;
  if (lefwState != LEFW_LAYERROUTINGWIDTH) return LEFW_BAD_ORDER;
  if (lefwWriteEncrypt)
...
int lefwLayerAntennaModel(const char* oxide) {
  ...
  if (!lefwIsRouting && !lefwIsCut) return LEFW_BAD_DATA;
  if (versionNum < 5.4)
     return LEFW_WRONG_VERSION;
  if (lefwWriteEncrypt)
...
int lefwLayerAntennaDiffAreaRatioPwl(int numPwls, double* diffusions,
                                     double* ratios) {
  int i;
...
int lefwLayerAntennaCumDiffAreaRatioPwl(int numPwls, double* diffusions,
                                     double* ratios) {
  int i;
...
int lefwLayerAntennaSideAreaRatio(double value) {
  ...
  if (!lefwIsRouting) return LEFW_BAD_DATA;
  if (versionNum < 5.4)
     return LEFW_WRONG_VERSION;
  if (lefwWriteEncrypt)
...
int lefwLayerAntennaDiffSideAreaRatioPwl(int numPwls, double* diffusions,
                                         double* ratios) {
  int i;
...
//              lefwLayerAntennaCumSideDiffAreaRatio to match the header  
...
int lefwLayerAntennaCumDiffSideAreaRatioPwl(int numPwls, double* diffusions,
                                         double* ratios) {
  int i;
...
int lefwSlotWireWidth(double minWireWidthForSlotting) {
...
int lefwSlotWireLength(double minWireLengthForSlotting) {
...
int lefwSlotWidth(double minSlotWidth) {
...
int lefwSlotLength(double minSlotLength) {
...
int lefwMaxAdjacentSlotSpacing(double maxAdjSlotSpacing) {
...
int lefwMaxCoaxialSlotSpacing(double maxCoaxSlotSpacing) {
...
int lefwMaxEdgeSlotSpacing(double maxEdgeSlotSpacing) {
...
int lefwSplitWireWidth(double minWireWidthForSplitting) {
...
int lefwMaxviastack(int value, const char* bottomLayer, 
                        const char* topLayer) {
  if (! lefwFile) return LEFW_UNINITIALIZED;
  if (! lefwDidInit) return LEFW_BAD_ORDER;
  if (lefwIsMaxviastack) return LEFW_BAD_ORDER;
  if (lefwWriteEncrypt) {
...
int lefwSite(const char* siteName, const char* classType, const char* symmetry,
  ...
  if (! lefwFile) return LEFW_UNINITIALIZED;
  if (! lefwDidInit) return LEFW_BAD_ORDER;
  if (lefwState == LEFW_SITE) return LEFW_BAD_ORDER;
  if (lefwState != LEFW_INIT && lefwState < LEFW_END)
     return LEFW_BAD_ORDER;  // not of the ENDs
...
int lefwArraySiteStr(const char* name, double origX, double origY, 
...
int lefwArrayCanplaceStr(const char* name, double origX, double origY,
                         const char* orient, double numX, double numY,
                         double spaceX, double spaceY) {
  if (! lefwFile) return LEFW_UNINITIALIZED;
  if (lefwState != LEFW_ARRAY_START &&
...
int lefwArrayCannotoccupyStr(const char* name, double origX, double origY,
                             const char* orient, double numX, double numY,
                             double spaceX, double spaceY) {
  if (! lefwFile) return LEFW_UNINITIALIZED;
  if (lefwState != LEFW_ARRAY_START &&
...
int lefwArrayFloorplanStr(const char* site, const char* name, double origX,
...
int lefwMacroClass(const char* value1, const char* value2) {
  ...
  if (lefwWriteEncrypt) {
     if (strcmp(value1, "RING") == 0)
        ...
        if (value2) {
           if (strcmp(value2, "BLACKBOX")) return LEFW_BAD_DATA;
           encPrint(lefwFile, (char*)"   CLASS %s %s ;\n", value1, value2);
        } else
           encPrint(lefwFile, (char*)"   CLASS %s ;\n", value1);
     } else if (strcmp(value1, "COVER") == 0) {
        if (value2) {
           if (strcmp(value2, "BUMP")) return LEFW_BAD_DATA;
           encPrint(lefwFile, (char*)"   CLASS %s %s ;\n", value1, value2);
        } else
           encPrint(lefwFile, (char*)"   CLASS %s ;\n", value1);
        ...
        if (value2) {
           if (strcmp(value2, "FEEDTHRU") && strcmp(value2, "TIEHIGH") &&
              ...
              strcmp(value2, "ANTENNACELL")) return LEFW_BAD_DATA;
           encPrint(lefwFile, (char*)"   CLASS %s %s ;\n", value1, value2);
        } else
           encPrint(lefwFile, (char*)"   CLASS %s ;\n", value1);
...
int lefwMacroForeignStr(const char* name,
                        double xl, double yl, const char* orient) {/*optional*/
  if (! lefwFile) return LEFW_UNINITIALIZED;
  if (! lefwDidInit) return LEFW_BAD_ORDER;
  if (lefwState != LEFW_MACRO_START &&
     lefwState != LEFW_MACRO) return LEFW_BAD_ORDER;
...
int lefwMacroSitePatternStr(const char* name, double origX, double origY,
...
int lefwMacroPinAntennasize(double value, const char* layerName) {
  ...
  if (! lefwDidInit) return LEFW_BAD_ORDER;
  if (! lefwIsMacroPin) return LEFW_BAD_ORDER;
  if (lefwAntenna54) return LEFW_MIX_VERSION_DATA;
  if (lefwWriteEncrypt) {
...
int lefwMacroPinAntennaPartialMetalArea(double value, const char* layerName) {
  ...
  if (versionNum < 5.4)
     return LEFW_WRONG_VERSION;
  if (lefwAntenna53) return LEFW_MIX_VERSION_DATA;
  if (lefwWriteEncrypt) {
...
int lefwMacroPinAntennaPartialMetalSideArea(double value,
...
int lefwMacroPinAntennaMaxAreaCar(double value, const char* layerName) {
  ...
  if (! lefwDidInit) return LEFW_BAD_ORDER;
  if (! lefwIsMacroPin) return LEFW_BAD_ORDER;
  if (lefwAMaxAreaCar) return LEFW_BAD_DATA;  // ANTENNAMAXAREACAR has defined
                                              // more than once
  if (versionNum < 5.4)
     return LEFW_WRONG_VERSION;
  if (lefwAntenna53) return LEFW_MIX_VERSION_DATA;
...
int lefwMacroPinAntennaMaxSideAreaCar(double value, const char* layerName) {
  ...
  if (! lefwDidInit) return LEFW_BAD_ORDER;
  if (! lefwIsMacroPin) return LEFW_BAD_ORDER;
  if (lefwAMaxSideAreaCar) return LEFW_BAD_DATA;  // ANTENNAMAXSIDEAREACAR has
...
int lefwMacroPinAntennaMaxCutCar(double value, const char* layerName) {
  ...
  if (! lefwDidInit) return LEFW_BAD_ORDER;
  if (! lefwIsMacroPin) return LEFW_BAD_ORDER;
  if (lefwAMaxCutCar) return LEFW_BAD_DATA;  // ANTENNAMAXCUTCAR has
                                             // defined more than once
  if (versionNum < 5.4)
     return LEFW_WRONG_VERSION;
  if (lefwAntenna53) return LEFW_MIX_VERSION_DATA;
...
int lefwMacroPinPortLayer(const char* layerName, double spacing) {
  ...
  if (!layerName || layerName == 0 || *layerName == 0) return LEFW_BAD_DATA;
  if (lefwWidthVal) return LEFW_BAD_DATA;
  if (lefwWriteEncrypt) {
     encPrint(lefwFile, (char*)"         LAYER %s ", layerName);
     if (spacing)
        encPrint(lefwFile, (char*)"SPACING %g ", spacing);
...
int lefwMacroPinPortDesignRuleWidth(const char* layerName, double width) {
  ...
  if (! lefwIsMacroPinPort) return LEFW_BAD_ORDER;
  if (!layerName || layerName == 0 || *layerName == 0) return LEFW_BAD_DATA;
  if (lefwSpacingVal) return LEFW_BAD_DATA;
  if (versionNum < 5.4)
     return LEFW_WRONG_VERSION;
  if (lefwWriteEncrypt) {
     encPrint(lefwFile, (char*)"         LAYER %s ", layerName);
...
int lefwAntennaInputGateArea (double inputGateArea) {
  ...
  if (lefwState != LEFW_INIT && lefwState < LEFW_END)
     return LEFW_BAD_ORDER;  // not of the ENDs
  if (lefwSynArray[LEFW_ANTENNAINPUTGATEAREA]) return LEFW_ALREADY_DEFINED;
  if (versionNum < 5.4)
     return LEFW_WRONG_VERSION;
  if (lefwWriteEncrypt)
...
int lefwAntennaInOutDiffArea (double inOutDiffArea) {
  ...
  if (lefwState != LEFW_INIT && lefwState < LEFW_END)
     return LEFW_BAD_ORDER;  // not of the ENDs
  if (lefwSynArray[LEFW_ANTENNAINOUTDIFFAREA]) return LEFW_ALREADY_DEFINED;
  if (versionNum < 5.4)
     return LEFW_WRONG_VERSION;
  if (lefwWriteEncrypt)
...
int lefwAntennaOutputDiffArea (double outputDiffArea) {
  ...
  if (lefwState != LEFW_INIT && lefwState < LEFW_END)
     return LEFW_BAD_ORDER;  // not of the ENDs
  if (lefwSynArray[LEFW_ANTENNAOUTPUTDIFFAREA]) return LEFW_ALREADY_DEFINED;
  if (versionNum < 5.4)
     return LEFW_WRONG_VERSION;
  if (lefwWriteEncrypt)
