...
#include "lex.h"
void 
lef_add_to_stringtab_Int(void *hdl, const char *str, int inValue)
{
  int    *value;

  /*
   * Modified 9/2/99 -- Wanda da Rosa
   *//* need to free this in FEF_stringhash.cpp */ value = (int *) lefMalloc(sizeof(int));
  if (value != NULL) {
    *value = inValue;
...
void 
lef_init_symbol_table(void *Keyword_set)
{
