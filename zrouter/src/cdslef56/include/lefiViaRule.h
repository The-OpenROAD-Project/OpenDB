...
EXTERN void
lefiViaRuleLayer_clearLayerOverhang
  PROTO_PARAMS(( lefiViaRuleLayer * this ));
...
EXTERN void
lefiViaRuleLayer_setOverhangToEnclosure
  PROTO_PARAMS(( lefiViaRuleLayer * this,
                 double d ));
...
EXTERN void
lefiViaRule_clearLayerOverhang
  PROTO_PARAMS(( lefiViaRule * this ));
...
EXTERN void
lefiViaRule_setOverhangToEnclosure
  PROTO_PARAMS(( lefiViaRule * this,
                 double d ));
