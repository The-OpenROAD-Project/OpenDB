...
tmg report_delay -master TC2BUFXE -in_pin A -out_pin Y

tmg report_delay -master TC2BUFXE -in_pin A -out_pin Y -in_slew 0.2

tmg report_delay -master TC2BUFXE -in_pin A -out_pin Y -in_slew 0.2 -cload 0.2

tmg report_delay -master TC2BUFXE -in_pin A -out_pin Y  -in_slew 0.2 -cload 0.175 -test 1
